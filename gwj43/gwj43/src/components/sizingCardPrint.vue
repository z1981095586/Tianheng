<template>
  <div>
    ...
    <div style="text-align: center;margin-top:20px" id="printTables" >
      <table  cellspacing='0' cellpadding='0' width="100%" style="">
        <tr style="height: 4px">
          ...
          <!-- <td colspan="2" style="width: 70%;text-align: left;height: 50px">
            <p style="font-size: 28px;font-weight: bolder">织轴卡</p>
          </td> -->
        ...
        <tr>
          <td colspan="5">
            <table cellspacing='0' cellpadding='0' width="100%" border="2">
              ...
              <tr>
                <td  style="font-size:14px;height:25px">品名</td>
                <td  style="font-size:14px;height:25px" colspan="3">{{headData.orderSheetPlan.productName}}</td>
              ...
              <tr>
                ...
                <td style="font-size:14px;height:25px" width="120px">批号</td>
                <td style="font-size:14px;height:25px" width="150px">{{this.headData.supplierCode}}</td>
                <td style="font-size:14px;height:25px" width="120px">轴号</td>
                <td style="font-size:14px;height:25px" width="150px">{{sizingInfoData.axisNo}}</td>
              </tr>
              <tr>
                <td style="font-size:14px;height:25px" width="120px">纱支</td>
                <td style="font-size:14px;height:25px" width="150px" colspan="3">{{sizingInfoData.yarnWeaving || ""}}</td>
                <!-- <td width="100px">落轴<br>次数</td>
                <td width="150px">{{sizingInfoData.vatNums}}-{{sizingInfoData.beamNums}}</td> -->
              </tr>
              <tr>
                <td style="font-size:14px;height:25px" width="120px" colspan="2">长度</td>
                <td style="font-size:14px;height:25px" width="150px" colspan="2">{{sizingInfoData.actualYarnLength}}M</td>
                <!-- <td width="100px">员工号</td>
                <td width="150px">{{headData.workerId}}</td> -->
              </tr>
              <tr>
                <td style="font-size:14px;height:25px" width="120px">落轴次数</td>
                <td style="font-size:14px;height:25px" width="150px">{{sizingInfoData.vatNums}}-{{sizingInfoData.beamNums}}</td>
                <td style="font-size:14px;height:25px" width="120px">员工号</td>
                <td style="font-size:14px;height:25px" width="150px">{{headData.workerId}}</td>
              </tr>
              <tr>
                <td style="font-size:14px;height:25px" width="120px">班次</td>
                <td style="font-size:14px;height:25px" width="150px"></td>
                <td style="font-size:14px;height:25px" width="120px">日期</td>
                <td style="font-size:14px;height:25px" width="150px">{{sizingInfoData.endDate.substring(0,10)}}</td>
              </tr>
            </table>
          </td>
        </tr>
    ...
    export default {
      ...
      methods:{
        ...
        print(){
          ...
          // this.companyId = 10000017
          if(this.companyId == 10000017 || this.companyId == 10000020){
            this.$nextTick(() => {
              this.printPdf(printerList);
            })
          }else{
        ...
        printPdf(printerName) {
          ...
          if(this.companyId == 10000017 || this.companyId == 10000020){
            ...
            let strFormHtml = strBodyStyle+"<body>" +document.getElementById("printTables").innerHTML +"</body>";
            LODOP.PRINT_INIT("织轴卡");
            LODOP.SET_PRINTER_INDEX(printerName);
            //LODOP.SET_PRINTER_INDEX("HP LaserJet 1020 (副本 1)");
            
            LODOP.SET_PRINT_STYLE("FontSize", 8);
            LODOP.ADD_PRINT_HTM("12%","3%", "97%", "97%", strFormHtml);
            LODOP.ADD_PRINT_BARCODE(2, 8, 65, 65, "QRCode",  this.sizingInfoData.printCode)
            LODOP.ADD_PRINT_BARCODE(2, 70, 250, 45, "128B",  this.sizingInfoData.printCode)
