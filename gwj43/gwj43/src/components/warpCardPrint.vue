  ...
  <div>
    ...
    <div style="text-align: center" id="printTable" >
      <table  cellspacing='0' cellpadding='0' width="100%">
        <!-- <tr>
          <td colspan="2" style="width: 50%;text-align: center;height: 0.3cm">
            <p style="font-size: 16px">经轴卡</p>
          </td>
          <td style="width: 25%"> -->
          ...
          <td colspan="4">
            <table cellspacing='0' cellpadding='0' border="1" width="96%" style="margin-left: 2%" >
              <tr style="font-size:16px">
                <td style="font-size:16px" width="120px">机台号</td>
              ...
              <tr style="font-size:16px">
                <td>纱支</td>
                <td style="font-size: 16px" colspan="3">{{warpInfoData.axisInfo.yarnWeaving}}</td>
              </tr>
              <tr style="font-size:16px">
                <td>长度</td>
