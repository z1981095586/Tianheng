<template>
  ...
  <div>
    ...
    >
      ...
      <table cellspacing='0' cellpadding='0' width="100%" style="width: 700px;">
        <tr>
            ...
            <table width="620px"  cellspacing='0' cellpadding='0' height="400px" style="display: inline-block">
              <tr v-for="indexTr in 2" >
                <td  v-for="indexTd in 5" style="text-align: center;">
                  <el-button type="primary" plain style="width: 110px;height: 110px;margin-right:5px;margin-bottom: 5px" size="medium"  @click="selectTableButton(buttonList[(indexTr-1)*5+indexTd-1])">
                    <p  style="font-weight: bolder;font-size: 70px;width: 100%">{{buttonList[(indexTr-1)*5+indexTd-1]}}</p>
                  </el-button>
                </td>
                <td v-if="indexTr===1">
                  <el-button type="primary" style="width:110px;height:110px;font-size: 35px;margin-bottom: 5px;font-weight: bolder" @click="finishChangeMachine">确定</el-button>
                </td>
                <td v-if="indexTr===2">
                  <el-button type="info" style="width:110px;height:110px;font-size: 35px;margin-bottom: 5px" @click="selectTableButton('退格')">清空</el-button>
                </td>
              </tr>
            </table>
          </td>
    ...
    <el-dialog
      ...
      append-to-body
    >
      <div style="text-align: center; font-size: 1.8rem; font-weight: bolder">
        是否确认修改信息
      </div>
      <div style="text-align: center;margin-top: 5vw">
        <el-button type="success" style="width: 8vw;height:8vw;margin-bottom: 5px;margin-right: 3vw" size="medium" @click="changePrint">
          <p  style="font-weight: bolder;font-size: 1.2rem;text-align:center;width: 100%;line-height:1.4;letter-spacing:4px;" >确认<br>修改</p>
        </el-button>
        <el-button type="primary" style="width: 8vw;height: 8vw;margin-bottom: 5px;margin-left: 3vw" size="medium" @click="showConfirmDialog = false">
          <p  style="font-weight: bolder;font-size: 1.2rem;width: 100%;line-height:1.4;letter-spacing:4px;">返回<br>页面</p>
        </el-button>
      </div>
    </el-dialog>
    <el-dialog
    ...
    >
      ...
      <div style="text-align: center;margin-top: 5vw">
        <el-button type="success" style="width: 8.3vw;height: 8.5vw;margin-bottom: 5px;margin-right: 2.5vw" size="medium" @click="addCloth">
          <p  style="font-weight: bolder;font-size: 1rem;width: 100%;line-height:1.4;letter-spacing:4px;" >确认<br>并打印</p>
        </el-button>
        <el-button type="primary" style="width: 8.3vw;height: 8.5vw;margin-bottom: 5px;margin-left: 2.5vw" size="medium" @click="showAddClothDialog = false">
          <p  style="font-weight: bolder;font-size: 1.2rem;width: 100%;line-height:1.4;letter-spacing:4px;">取消<br>新增</p>
        </el-button>
      </div>
    </el-dialog>
    <!--新增织造单-->
    ...
    >
      ...
      <div style="text-align: center;margin-top: 5vw">
        <el-button type="success" style="width: 8.5vw;height: 8.3vw;margin-bottom: 5px;margin-right: 2.5vw" size="medium" @click="yieldNewBarCode">
          <p  style="font-weight: bolder;font-size: 1rem;width: 100%;line-height:1.4;letter-spacing:4px;">确认<br>并打印</p>
        </el-button>
        <el-button type="primary" style="width: 8.5vw;height: 8.3vw;margin-bottom: 5px;margin-left: 2.5vw" size="medium" @click="showAddNewClothDialog = false">
          <p  style="font-weight: bolder;font-size: 1.3rem;width: 100%;line-height:1.4;letter-spacing:4px;">取消<br>新增</p>
        </el-button>
      </div>
    </el-dialog>
      ...
      <div>
        <div :style="{height: scrollerHeightTop,width:scrollerWidthLeft}" style="display: inline-block">
          <el-card style="width: 100%;" :style="{height: scrollerHeightTop,width:scrollerWidthLeft}" shadow="hover">
            ...
            <!--</el-button>-->
            <!--</div>-->
            <div style="width: 100%;margin-left: 0%;display: inline-block;vertical-align: top" >
              <p class="standard_font">点击下方区域扫描生产批号</p>
              <input v-model="barCode" :style="{height:inputHeight,paddingRight:paddingRight}"  @input="batchCodeChange(barCode)"   style="display: inline-block;font-size: 13px;font-weight :bold;width: 100%"></input>
        ...
        <div :style="{height: scrollerHeightBottom,width:scrollerWidthLeft}"  style="display: inline-block" >
          <el-card style="width:100%;" :style="{height: scrollerHeightBottom,width:scrollerWidthLeft}" shadow="hover" body-style="">
            <div class="left-bottomDiv" id="leftDiv"  :style="" style="overflow-y: hidden;height: 90%" @mousedown="mousedown" @touchstart="mousedown" @mousemove="move" @mouseup="end" @touchmove.prevent="move"  @touchend="end" >
              <div class="standard_border" :style="{height:scrollerHeightBottomDiv,backgroundColor:getLabelColor(item.status)}" v-for="item in all_order_list" :label="item.barCode" :key="item.id" style="width: 100%;display: inline-block;margin-left: 0%;margin-top: 5px;border-width:2px;padding: 10px" >
                <table cellspacing='0px' cellpadding='20px' border="0" width="100%">
                  <tr>
                    <td colspan="2" style="border-bottom: 1px solid lightgray">
                      <p style="display: inline-block;margin-top: 0px;font-size: 2.1vw;font-weight: bolder">织造上轴加工单&nbsp</p>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <p class="standard_font" style="font-size: 1.2rem;font-weight: bolder;margin-top: 8px;">{{plan_code}}</p>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <p class="standard_font" style="font-size: 1.2rem;font-weight: bolder;margin-top: 5px;">预排机台：&nbsp{{item.machineIdPlan || "无"}}</p>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <p class="standard_font" style="font-size: 1.2rem;font-weight: bolder;margin-top: 5px;">实际机台：&nbsp{{item.machineId || machineIdSelected}}</p>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <p class="standard_font" style="font-size: 1.2rem;font-weight: bolder;margin-top: 5px;">轴号：&nbsp{{item.axisNo}}</p>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <p class="standard_font" style="font-size: 1.2rem;text-transform: uppercase;font-weight: bolder;margin-top: 5px;">品种：&nbsp{{item.productNameWeaving}}</p>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <p class="standard_font" style="font-size: 1.1rem;font-weight: bolder;margin-top: 5px;text-transform: uppercase;">纬纱批号：&nbsp{{item.lmWeavingPlanB.supplierCode}}</p>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <p class="standard_font" style="font-size: 1.1rem;font-weight: bolder;margin-top: 5px;text-transform: uppercase;">纬纱产地：&nbsp{{item.lmWeavingPlanB.supplierName}}</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <el-button type="success" style="margin-top: 15px;width: 8.2vw;height: 7vw;margin-bottom: 5px;line-height:1.4;letter-spacing:4px" size="medium"  @click="getPrintStatus">
                        <p  style="font-weight: bolder; font-size: 1.2rem;width: 100%">确认<br>提交</p>
                      </el-button>
                    </td>
                    <td>
                      <el-button slot="reference" type="danger" style="margin-top: 15px;width: 8.2vw;height: 7vw;margin-bottom: 5px;margin-left: 13px;line-height:1.4;letter-spacing:4px" size="medium"  @click="showChangeMachine">
                        <p  style="font-weight: bolder;font-size: 1.2rem;width: 100%">修改<br>信息</p>
                      </el-button>
                    </td>
                  </tr>
                </table>
            ...
            <div class="left-bottomDiv" :style="{height: scrollerHeightBottomDiv}" id="rightDiv"  @mousedown="mousedown1" @touchstart="mousedown1" @mousemove="move1" @mouseup="end1" @touchmove.prevent="move1"  @touchend="end1" v-show="radio!='radio5'"   >
                ...
                <tr>
                  <td style="text-align: center;width: 33%" @click="">
                    <div style="height :15vh" @click="addBySelf">
                      ...
                      <div style="height:10vh;font-size: 2rem;margin-top: 2%;font-weight: bolder">手动新增</div>
                    </div>
                  </td>
              ...
              <div class="changeWS" v-show="radio === 'radio2'">
                <div class="changeWS-row">
                  ...
                  <div >
                    <span>经纱产地:</span>
                    <span style="font-size: 1.2rem;text-transform: uppercase">{{ZjwarpsupplierName}}</span>
                  </div>
                  <div>
                    <span>经纱批号:</span>
                    <span style="font-size: 1.2rem;text-transform: uppercase">{{ZjwarpsupplierCode}}</span>
                  </div>
                </div>
                <div class="changeWS-row">
                ...
                <div class="changeWS-btn">
                  ...
                  <div>
                    <el-button type="success" style="width: 8.5vw;height: 7.5vw;margin-bottom: 5px;line-height:1.4;letter-spacing:4px" size="medium" @click="addBySelf">
                      <p  style="font-weight: bolder; font-size: 1.3rem;width: 100%;" >确认<br>提交</p>
                    </el-button></div>

                  <div> <el-button type="danger" style="width:8.5vw;height:7.5vw;font-size: 1.3rem;margin-bottom: 5px;font-weight: bolder" size="medium" @click="resetRecord">取消</el-button></div>
              ...
              <table class="radioTable"  style="width: 95%" cellspacing="30px" v-show="radio === 'radio3'" >
                <tr v-for="indexTr in machine_detail_list_length">
                  <td :id="indexTd+indexTr*3-3+'radio3'" v-for="indexTd in 3" v-if="(indexTd+indexTr*3-3)<=machine_detail_list.length"  style="text-align: left;width: 33%" @click="setMachineId(indexTd+indexTr*3-3+'radio3')">
                    <div style="height:16vh;margin-top: 10%;width: 96%">
                      <div style="height:5vh;font-size: 1rem;border-bottom: 1px solid lightgray;font-weight: bolder">机器号：{{machine_detail_list[indexTd+indexTr*3-4].machineid}}</div>
                      <div style="height:5vh;font-size: 1rem;font-weight: bolder;">了机时间：{{machine_detail_list[indexTd+indexTr*3-4].machineEndHours}}h</div>
                      <div style="height:9vh;font-size: 1rem;font-weight: bolder;">当前品种：{{machine_detail_list[indexTd+indexTr*3-4].styleName}}</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      getUrlMessage() {
        let params = this.$route.params.params.split(",");//讲网页的参数转化为数组
        let message = params[0];//gwj43
        // console.log(params);
        this.companyId = params[1];//10000015
        ...
        warp_api(url, data, this.companyId)
          .then(response => {
            ...
            if (response.data.data) {
              ...
              // this.order_detail_list[0].WeavingsupplierName = changeWSData.lmWeavingPlanB.supplierName;
              // this.order_detail_list[0].WeavingsupplierCode= changeWSData.lmWeavingPlanB.supplierCode;
      ...
      addCloth() {
        ...
        for (let i = 0; i < this.addNumber; i++) {
          ...
          message.warpSupplierCode= this.ZjwarpsupplierCode,
          message.warpSupplierName= this.ZjwarpsupplierName,
          message.weftSupplierCode= this.WeavingsupplierCode,
          message.weftSupplierName= this.WeavingsupplierName
      ...
      printClothCardReturn(order_detail_list, print_meter) {
        ...
        if (order_detail_list.length > 0) {
          ...
          data.supplierCode = this.all_order_list[0].supplierCode;
          data.supplierName = this.all_order_list[0].supplierName;
          ...
          for (let i = 0; i < order_detail_list.length; i++) {
            clothEaches.push({
              ...
              remark: "",
              warpSupplierCode: this.ZjwarpsupplierCode,
              warpSupplierName: this.ZjwarpsupplierName,
              weftSupplierCode: this.WeavingsupplierCode,
              weftSupplierName: this.WeavingsupplierName
            })
          }
      ...
      changeWSName(){
        this.all_order_list[0].lmWeavingPlanB.supplierCode = this.WeavingsupplierCode;
        let data = {};
        data.tableName = "u_supplier_category";
        data.query = {
          lot_no: this.WeavingsupplierCode
        };
        console.log(data)
        common_api("/report/getSimpleReport", data,this.companyId)
          .then(response => {
            ...
            switch(response.data.data.length){
              case 0:
                ...
                break;
              case 1:
                this.all_order_list[0].lmWeavingPlanB.supplierName = this.WeavingsupplierName = response.data.data[0].supplier_category_name;
                break;
              default:
