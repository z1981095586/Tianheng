<template>
  <div style="height: 80px;background-color: #29374b;width: 100%">
    <el-dialog
      ...
      :modal="false"
    >
      <el-tabs type="border-card" style="width: 100%;height: 550px;overflow-y: auto" v-model="settingMode">
        <el-tab-pane label="班次管理" name="shiftManage">
          ...
          <div style="margin-top: 10px;width: 100%;text-align: center">
            <el-tooltip class="item" effect="dark"  placement="top">
              ...
              <el-button type="success"  style="width: 100px;height:90px;font-size: 24px" @click="add_new_shift">新增</el-button>
            </el-tooltip>
            <el-tooltip class="item" effect="dark"  placement="top">
              ...
              <el-popconfirm
                ...
                title="确定要删除最后一行吗？"
              >
                <el-button type="danger" slot="reference" style="width: 100px;height:90px;font-size: 24px" @click="">删除</el-button>
              </el-popconfirm>
            </el-tooltip>
            <el-button type="primary"  style="width: 100px;height:90px;font-size: 24px" @click="saveShift">保存</el-button>
          </div>
        </el-tab-pane>
          ...
          <div v-show="!ifGetPermission">
            ...
            <table width="620px"  cellspacing='0' cellpadding='0' height="400px" style="margin-top: 20px;display: inline-block">
              <tr v-for="indexTr in 2" >
                ...
                <td v-if="indexTr===1">
                  <el-button type="primary" style="width:150px;height:150px;font-size: 45px;margin-bottom: 5px" @click="getPermission">确定</el-button>
                </td>
                <td v-if="indexTr===2">
    ...
    >
      ...
      <table width="620px"  cellspacing='0' cellpadding='0' height="300px" style="display: inline-block">
        <tr v-for="indexTr in 2" >
          ...
          <td v-if="indexTr===1">
            <el-button type="primary" style="width: 10rem;height: 7rem;font-size: 3rem;margin-bottom: 5px;font-weight: bolder" @click="searchStaff">确定</el-button>
          </td>
          <td v-if="indexTr===2">
          ...
          <div class="changeMachineDiv" style="display: inline-block">
            <el-select ref="machineId" v-model="machineId" filterable placeholder="请选择" @focus="changeFocus('machineId')">
              <el-option
                ...
                style="line-height: 80;height: 80px"
              >
        ...
        <el-tab-pane label="报修历史" name="repairHis">
          <el-table
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                <el-button
                  v-if="scope.row.isok === 2||scope.row.isok === 3"
                  type="danger"
                  @click="repairFinished(scope.$index, scope.row)">维修完成</el-button>
                <el-button
                  v-if="scope.row.isok === 1"
                  type="danger"
                  @click="repairAgain(scope.$index, scope.row)">再次报修</el-button>
              </template>
            </el-table-column>
          </el-table>
    ...
    <table cellspacing='0' cellpadding='0' border="0" width="100%" style="height: 80px">
      <tr>
        ...
        <td style="width: 550px;font-size: 50px;color: white">
          <Icon type="md-power" @click="exit" />
          <p v-model="staff_name" style="width: 160px;position: fixed;top:18px;left:540px;font-size: 35px;color: #ffffff" @click="ifWorkerNameNotExist = true">{{staff_name}}</p>
