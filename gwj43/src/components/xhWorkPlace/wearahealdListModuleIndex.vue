        ...
        <div :style="{height: scrollerHeightTop,width:scrollerWidthLeft}" style="display: inline-block">
          <el-card style="width: 100%;" :style="{height: scrollerHeightTop,width:scrollerWidthLeft}" shadow="hover">
            <div style="width: 100%;" >
              ...
              <input v-model="batchCode" :style="{height:inputHeight,paddingRight:paddingRight}" @input="batchCodeChange()"   style="display: inline-block;font-size: 13px;font-weight :bold;width: 100%"></input>
                ...
                <td rowspan="6" style="width: 300px;border-width: 3px;"   @click=" showChangeReedNumber = true">
                  <div style="width: 100%;margin-top:-15px;margin-left: 20px" :style="{height:scrollerHeightRightButton}">
                    ...
                    <div style="width: 100%;background-color: #e5e6e9;height: 25%">
                      <p class="big_font"  style="text-align: center">点击此区域更换筘号</p>
                    </div>
                  </div>
                </td>
              </tr>
        ...
        <div :style="{height: scrollerHeightBottom,width:scrollerWidthLeft}"  style="display: inline-block" >
          <el-card style="width: 100%;" :style="{height: scrollerHeightBottom,width:scrollerWidthLeft}" shadow="hover" body-style="">
            <div class="left-bottomDiv" id="leftDiv"  style="height: 90%" @mousedown="mousedown" @touchstart="mousedown" @mousemove="move" @mouseup="end" @touchmove.prevent="move"  @touchend="end" >
              <div class="standard_border" @click="changeByCardNumber(item)" :style="{height:scrollerHeightBottomDiv,backgroundColor:getLabelColor(item.status)}" v-for="item in all_order_list" :label="item.batchCode" :key="item.id" style="width: 97%;display: inline-block;margin-bottom: 10px;border-width:2px;padding: 10px" >
                <table cellspacing='5px' cellpadding='20px' border="0" width="100%">
                  <tr>
                    <td colspan="2" style="border-bottom: 1px solid lightgray">
                      <p style="display: inline-block;margin-top: 5px;font-size: 1.2rem;font-weight: bolder">穿综加工单&nbsp</p>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <p class="standard_font" style="font-size: 0.9rem;font-weight: bolder">{{item.printCode}}</p>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <p class="standard_font" style="font-size: 1rem;font-weight: bolder">实际机台：&nbsp{{item.machineId || null}}</p>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <p class="standard_font" style="font-size: 1rem;font-weight: bolder">总经根数：&nbsp{{item.rootNumber}}</p>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <p class="standard_font" style="font-size: 1rem;font-weight: bolder">品种：&nbsp{{item.productName}}</p>
                    </td>
                  </tr>
                  <!--<tr>-->
                    <!--<td>-->
        ...
        <div :style="{height: scrollerHeightBottom,width:scrollerWidthLeft}"  style="display: inline-block;margin-left: 10px">
          <el-card style="width: 100%;" :style="{height: scrollerHeightBottom,width:scrollerWidthRight}" shadow="hover" >
            ...
            <div class="left-bottomDiv" :style="{height: scrollerHeightBottomDiv}" id="rightDiv"  @mousedown="mousedown1" @touchstart="mousedown1" @mousemove="move1" @mouseup="end1" @touchmove.prevent="move1"  @touchend="end1" >
              <div class="standard_border" :style="{height:label_height_right}" v-for="item in order_detail_list" :label="item.axisNo" :key="item.axisNo" style="width: 90%;margin-bottom: 10px;border-width:2px;padding: 10px" >
                <!--<el-tabs type="border-card">-->
                  <!--<el-tab-pane label="穿综计划">-->
                    <table id="rightLabel" cellspacing='0' cellpadding='0' border="0" width="95%"  style="height: 100px;overflow-y: scroll">
                      <tr>
