        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <button class="sub" @click="deleteItem(scope.row.id)"  v-preventReClick
              style="background:#red;width:45%;height:60%;border:none;margin-left:1rem;color:white"><span>删除</span></button>
            </div>
...
<script>
 ...
 warping_id:String(this.order_list.id)
      ...
      deleteItem(id) {
        console.log(id)
        let url = "http://120.55.124.53:14100/warping/deleteProduceForm"
