...
import cz from '@/components/xhWorkPlace/13/cz.vue'
import machineRepairsIndex from '@/components/xhWorkPlace/machineRepairsIndex'
...
export default new Router({
  routes: [
    ...
    {
      path: '/machineRepairsIndex/:params',
      name: 'machineRepairsIndex',
      component: machineRepairsIndex
      //报修页面
    },
