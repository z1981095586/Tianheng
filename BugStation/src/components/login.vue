<template>
  <div class="allPage">
    <div class="loginFrame">
      ...
      <div class="loginForm">
        <div class="login_font">账户密码登录<div class="line"></div>
        </div>
        <div class="input"><img src="../common/icon/user.png" /><input placeholder="账户" v-model="user" /><span
            class="error" v-show="error1">请输入账户名</span></div>
        <div class="input"><img src="../common/icon/lock.png" /><input placeholder="密码" v-model="pass"
            type="password" onpaste="return false" oncontextmenu="return false" oncopy="return false" oncut="return false" /><span class="error" v-show="error2">请输入密码</span></div>
        <el-checkbox v-model="autoLogin" size="medium" style="font-size:2rem;margin-top:2.2rem;">自动登录</el-checkbox>
        <el-button type="primary" style="width:100%;font-size:1.5rem;margin-top:1.2rem;" :loading="isLoading"
          @click="loginTo()">{{btnTxt}}</el-button>
