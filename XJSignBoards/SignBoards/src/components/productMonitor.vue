<template xmlns:el-col="http://www.w3.org/1999/html">
  ...
  <div class="content4">
    <header>
      <div class="title"><span @mouseover="mouseover_cz()"
          @mouseleave="mouseleave_cz()">{{workshopName}}智能织造数字化平台</span></div>
      <h1 class="tip">
        ...
        <el-dialog id="dialog" center width="22%" :modal="false" :visible.sync="dialogFormVisible">
          <el-button
            ...
            @click="choseFactory(item.value,item.label)" v-for="item in workshopList" :key="item.value">{{item.label}}
          </el-button>
        </el-dialog>
        ...
        <!-- <span style="float: right;margin-right: 19.5%" @mouseover="mouseover_zb()" @mouseleave="mouseleave_zb()"
         >{{date | formatDate}} </span> -->
        <span style="float: right;margin-right: 19.5%">{{date | formatDate}} </span>
      </h1>
    </header>
    <el-row :gutter="5" style="position:relative">
      <div class="zj_board" @mouseover="mouseover_zj()" @mouseleave="mouseleave_zj()" :style="show_zjboard">
        <div style="width:100%;height:100%;display:flex;align-items:center;justify-content: center;">
          <div class="zj_board_con">
            <div class="zj_board_con_title">{{workshopName}}分厂整经生产车间管理看板</div>
            <div class="zj_board_con_time"><span>{{date | formatDate}}&nbsp;&nbsp;&nbsp;{{week}}</span></div>
            <div class="zj_board_con_table">
              <div class="zj_board_con_table_con">
                <div class="table_con">总整经实时产量:{{ zjcjSum}}</div>
                <div class="table_con">总平均速度：{{ zjcjSpeed}} m/min</div>
                <div class="table_con" style="height:13%">排产计划</div>
                <div class="table_con" style="height:13%">排产计划</div>
                <div class="table_con" v-for=" (item,index) in BarCodeList" :key="'bar'+index">{{item}}</div>

                <div class="small_table_con" v-for="(item,index) in zj_tablehead" :key="index">{{item.item}}</div>
                <div class="table_data" v-for="(item,index) in zjcjList" :key="'zj'+index" :style="item.color">
                  <div class="table_data_con">{{item.machineName}}</div>
                  <div class="table_data_con">{{item.empId}}</div>
                  <div class="table_data_con">{{item.barCode}}</div>
                  <div class="table_data_con">{{item.nameC}}</div>
                  <div class="table_data_con">{{item.inlthTotal}}</div>
                  <div class="table_data_con">{{item.dtl}}</div>
                  <div class="table_data_con">{{item.maximumBrokenEnds}}</div>
                  <div class="table_data_con">{{item.finish}}</div>
                </div>
      ...
      <div class="js_board" @mouseover="mouseover_js()" @mouseleave="mouseleave_js()" :style="show_jsboard">
        <div style="width:100%;height:100%;display:flex;align-items:center;justify-content: center;">
          <div class="zj_board_con">
            <div class="zj_board_con_title">{{workshopName}}分厂浆纱生产车间管理看板</div>
            <div class="zj_board_con_time"><span>{{date | formatDate}}&nbsp;&nbsp;&nbsp;{{week}} </span></div>
            <div class="zj_board_con_table">
              <div class="zj_board_con_table_con">
                <div class="table_con1">实时产量</div>
                <div class="table_con1">实时平均速度</div>
                <div class="table_con1">计划开轴数</div>
                <div class="table_con1">实际开轴数</div>
                <div class="table_con1">计划长度</div>
                <div class="table_con1_con">{{jscjSum}}m</div>
                <div class="table_con1_con">{{jscjSpeed}}m/min</div>
                <div class="table_con1_con"></div>
                <div class="table_con1_con"></div>
                <div class="table_con1_con"></div>
                <div class="table_con" style="height:13%">经纱织数</div>
                <div class="table_con" style="height:13%">经纱厂家</div>
                <div class="table_con"></div>
                <div class="table_con"></div>
                <div class="small_table_con" style="width:14.15%;" v-for="(item,index) in js_tablehead" :key="index">
                  {{item.item}}</div>
                <div class="table_data" v-for="(item,index) in jscjList" :key="'js'+index" :style="item.color">
                  <div class="table_data_con1">{{item.machineName}}</div>
                  <div class="table_data_con1">{{item.empId}}</div>
                  <div class="table_data_con1">{{item.speed}}</div>
                  <div class="table_data_con1">{{item.actualYarnLength}}</div>
                  <div class="table_data_con1">{{item.yarnLength}}</div>
                  <div class="table_data_con1">{{item.workQty}}</div>
                  <div class="table_data_con1">{{item.beamName}}</div>
      ...
      <div class="cz_board" :style="show_czboard">
        <div style="width:100%;height:100%;display:flex;align-items:center;justify-content: center;">
          <div class="zj_board_con">
            <div class="zj_board_con_title">{{workshopName}}自动穿生产车间管理看板</div>
            <div class="zj_board_con_time"><span>{{date | formatDate}}&nbsp;&nbsp;&nbsp;{{week}} </span></div>
            <div class="zj_board_con_table">
              <div class="zj_board_con_table_con">

                <div class="table_con" style="height:21%;color:red;">生产计划</div>
                <div class="table_con" style="height:21%">已完成生产计划</div>
                <div class="table_con" style="height:17%"></div>
                <div class="table_con" style="height:17%"></div>
                <div class="table_con" style="height:17%"></div>
                <div class="table_con" style="height:17%"></div>
                <div class="small_table_con" style="width:14.15%;" v-for="(item,index) in cz_tablehead" :key="index">
                  {{item.item}}</div>
                <div class="table_data">
                  <div class="table_data_con1"></div>
                  <div class="table_data_con1"></div>
                  <div class="table_data_con1"></div>
                  <div class="table_data_con1"></div>
                  <div class="table_data_con1"></div>
      ...
      <div class="zb_board" :style="show_zbboard" @mouseover="mouseover_zb()" @mouseleave="mouseleave_zb()">
        <div style="width:100%;height:100%;display:flex;align-items:center;justify-content: center;">
          <div class="zj_board_con">
            <div class="zj_board_con_title">{{workshopName}}分区织布车间一区管理看板</div>
            <div class="zj_board_con_time"><span>{{date | formatDate}} &nbsp;&nbsp;&nbsp;{{week}}</span></div>
            <div class="zj_board_con_table">
              <div class="zj_board_con_table_con">
                ...
                <div class="zb_top">
                  <div class="zb_top_left">
                    <div class="zb_top_left_top">
                      <div class="zb_title">预了机时间</div>
                      <div class="zb_content">
                        <div class="zb_content_one" v-for="(item,index) in yljList" :key="index">
                          <span style="   margin-left: 10%;">#{{item.machineId}}</span><span
                            style="    text-align: center; ">{{item.beamOutTime}}min</span></div>
                      </div>
                    </div>
                    <div class="zb_top_left_bottom">
                      <div class="zb_title">待机时长</div>
                      <div class="zb_content">
                        <div class="zb_content_one" v-for="(item,index) in daijiList" :key="index" style="height:13%">
                          <span style="   margin-left: 10%;">#{{item.machineId}}</span><span
                            style="    text-align: center; ">{{item.liaojiTimeNum}}min</span></div>
                      </div>
                    </div>
                  </div>
                  <div class="zb_top_middle">
                    <div class="zb_top_middle_top">
                      <div class="zb_top_middle_top_con">当班效率：{{dbxl}}%</div>

                      <div class="zb_top_middle_top_con">平均车速：{{speed}}%</div>

                      <div class="zb_top_middle_top_con">折标产量：{{zbcl}}%</div>

                    </div>
                    <div class="zb_top_middle_middle">个人排名</div>
                    <div class="zb_top_middle_bottom">
                      <div class="zb_top_middle_bottom_con" v-for="(item,index) in lm_shiftList"
                        :key="'lm_shift'+index">
                        <span>{{item.staffName}}</span>
                        <span>{{item.rpm}}</span>
                        <span>{{item.productMeter}}</span>

                      </div>

                    </div>
                  </div>
                  <div class="zb_top_right">
                    <div class="zb_top_right_con">
                      <div class="zb_title">低机效率</div>
                      <div class="zb_content">
                        <div class="zb_content_one" v-for="(item,index) in djxlList" :key="index" style="height:15%">
                          <span style="   margin-left: 10%;">#{{item.machineid}}</span><span
                            style="    text-align: center; ">{{item.shiftEfficiencyF}}</span></div>
                      </div>
                    </div>
                    <div class="zb_top_right_con">
                      <div class="zb_title">设备维修</div>
                      <div class="zb_content">
                        <div class="zb_content_one" v-for="(item,index) in sbwxList" :key="index" style="height:15%">
                          <span :style="item.color" style="   margin-left: 10%;">#{{item.machineId}}</span><span
                            :style="item.color">{{item.status}}</span></div>
                      </div>
                    </div>
                    <div class="zb_top_right_con">
                      <div class="zb_title">断经</div>
                      <div class="zb_content">
                        <div class="zb_content_one" v-for="(item,index) in djList" :key="index" style="height:15%">
                          <span style="   margin-left: 10%;">#{{item.machineid}}</span><span
                            style="    text-align: center; ">{{item.warpC}}次</span></div>
                      </div>
                    </div>
                    <div class="zb_top_right_con">
                      <div class="zb_title">断纬</div>
                      <div class="zb_content">
                        <div class="zb_content_one" v-for="(item,index) in dwList" :key="index" style="height:15%">
                          <span style="   margin-left: 10%;">#{{item.machineid}}</span><span
                            style="    text-align: center; ">{{item.weftC}}次</span></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="zb_bottom">
                  <div class="zb_bottom_left"><span>昨日对比</span></div>
                  <div class="zb_bottom_right">
                    <div class="zb_bottom_right_con">A班 本区域效率：{{dbxl}}%</div>
                    <div class="zb_bottom_right_con">本区折标产量：{{zbcl}}</div>
                    <!-- <div class="zb_bottom_right_con">总折合产量：85.2</div> -->
                    <div class="zb_bottom_right_con">B班 本区域效率：{{bbxl}}%</div>
                    <div class="zb_bottom_right_con">本区折标产量：{{bbcl}}</div>
                    <!-- <div class="zb_bottom_right_con">总折合产量：85.2%</div> -->
                  </div>
                </div>
      ...
      <el-col :span="17" style="       width: 55.83333%;" @mouseover="mouseover_cz()" @mouseleave="mouseleave_cz()">
        <el-row>
          <el-col :span="24">
      ...
      <el-col :span="7" style="    width: 44.16667%;">
        <div class="monitor" style="position:relative;">
          ...
          <div class="monitor_con">
            ...
            <div class="fangkuai2" @click="to('js')">
            ...
            <div class="fangkuai2" @click="to('yb')">
          ...
          <div style="display:flex;width:100%;height:30%">
            <div style="width:50%;height:100%;display:flex;flex-direction:column;">
              <div class="monitor_title2" style="margin-top:0"><span>各品种产量占比</span></div>
              <div class="echart1" id="yj_echart"></div>
            </div>
            <div style="width:50%;height:100%;display:flex;flex-direction:column;">
  ...
  <div class="echart2" id="echart2"></div> -->
                ...
                <div class="problemsFocus">
                  <div style="text-align: left;margin-left: 5%;padding-top: 1.2rem">
                    ...
                    <el-select v-model="problemDefaultValue" @change="changeProblems(problemDefaultValue)">
                      <el-option v-for="item in problemOptions" :key="item.value" :label="item.label"
                        :value="item.value">
                      </el-option>
                    </el-select>
                    <span class="tbTitle">效率最高:{{maxEfficiency}}%</span>
                    <!--,{{$t('lang.pingjun')}}{{avgEfficiency}}%-->
                  </div>
                  <hr style="width: 90%;border: 1px solid lightblue;;">
                  <div style="margin-left: 6%;overflow-y:hidden;height: 15.5rem;width: 40rem"
                    v-show="this.problemDefaultValue==='1'">
                    <div style="float: left;margin:0.2rem 0.4rem;width: 18rem;height:2.2rem;text-align: left"
                      v-for="item in machineEfficiency" class="tbText">
                      <!--<div style="float: left;padding-top: 0.18rem;width: 2.5rem">-->{{item.machineNum}}：{{$t('lang.kaijixiaolv')}}
                      {{item.openEfficiency}}%</div>
                  </div>
                  <div style="margin-left: 6%;overflow-y:hidden;height: 15.5rem;width: 40rem"
                    v-show="this.problemDefaultValue==='4'">
                    <div style="float: left;margin:0.2rem 0.4rem;width: 18rem;height:2.2rem;text-align: left"
                      v-for="item in machineEfficiency" class="tbText">
                      <!--<div style="float: left;padding-top: 0.18rem;width: 2.5rem">-->{{item.machineNum}}：{{$t('lang.kaijixiaolv')}}
                      {{item.openEfficiency}}%</div>
                  ...
                  <div style="margin-left: 6%;overflow-y:hidden;height: 15.5rem;width: 40rem"
                    v-show="this.problemDefaultValue==='2'">
                    <div style="float: left;margin:0.2rem 0.4rem;width: 18rem;height:2.2rem;text-align: left"
                      v-for="item in machineChanliangb" class="tbText">
                      <!--<div style="float: left;padding-top: 0.18rem;width: 2.5rem">-->{{item.machineNum}}：{{$t('lang.chanliang')}}
                      {{item.chanliangb}}{{$t('lang.mi')}}</div>
                  </div>
                  <div style="margin-left: 6%;overflow-y:hidden;height: 15.5rem;width: 40rem"
                    v-show="this.problemDefaultValue==='5'">
                    <div style="float: left;margin:0.2rem 0.4rem;width: 18rem;height:2.2rem;text-align: left"
                      v-for="item in machineChanliangb" class="tbText">
                      <!--<div style="float: left;padding-top: 0.18rem;width: 2.5rem">-->{{item.machineNum}}：{{$t('lang.chanliang')}}
                      {{item.chanliangb}}{{$t('lang.mi')}}</div>
                  ...
                  <div style="margin-left: 6%;overflow-y:hidden;height: 15.5rem;width: 40rem"
                    v-show="this.problemDefaultValue==='3'">
                    <div style="float: left;margin:0.2rem 0.4rem;width: 18rem;height:2.2rem;text-align: left"
                      v-for="item in weftCmpx" class="tbText">
          ...
          <div style="display:flex;width:100%;height:30%">
            <div style="width:50%;height:125%;display:flex;flex-direction:column;">
              <div class="monitor_title4"><span>织机班次产量对比</span></div>
              <div class="echart3" id="echart3"></div>
            </div>
            <div style="width:50%;height:100%;display:flex;flex-direction:column;   margin-top: 2rem;">
              <!-- <div class="monitor_title3" style="margin-top:0"><span>设备实时开机率</span></div>
  <div class="echart2" id="echart2"></div> -->
              <el-col :span="24">
                <div class="warningPush">
                  <div style="text-align: left;padding-top: 1rem;margin-left: 1rem">
                    <!--<el-button style="background-color: transparent; border-radius: 10px" size="small" class="tbTitle">预警推送</el-button>
                    <el-button class="tbTitle" size="small" style="margin-left: 1rem;background-color: transparent;border-radius: 8px">了机预测</el-button>-->
                    <el-tabs class="eltabs" v-model="activeName" type="card" @tab-click="handleClick">
                      <el-tab-pane label="了机预测" name="first">
                        <el-row>
                          <el-col :span="12">
                            <!--<div style="width: 100%;margin-left:1.2rem;font-size: 1rem;font-weight:bolder;color: lightblue" >{{$t('lang.shebeihao')}}&nbsp;&nbsp;{{$t('lang.yuceshijian')}}&nbsp;&nbsp;{{$t('lang.shengyujingzhouchang')}}</div>-->
                            <el-table :data="lioajiData.slice(0,this.lioajiData.length/2)" height="15rem"
                              :row-style="tableRowStyle4" :header-cell-style="tableHeaderColor4"
                              :cell-style="tableCellStyle4" class="dataTable" style="width:98.8">
                              <el-table-column prop="machineId" label="设备号">
                              </el-table-column>
                              <el-table-column prop="beamOutTime" label="预测时间">
                              </el-table-column>
                              <el-table-column prop="remainingLengthMeter" label="剩余经轴长">
                              </el-table-column>
                          ...
                          <el-col :span="12">
                            <!--<div style="width: 100%;margin-left:1.2rem;font-size: 1rem;font-weight:bolder;color: lightblue" >{{$t('lang.shebeihao')}}&nbsp;&nbsp;{{$t('lang.yuceshijian')}}&nbsp;&nbsp;{{$t('lang.shengyujingzhouchang')}}</div>-->
                            <el-table :data="lioajiData.slice(this.lioajiData.length/2,this.lioajiData.length)"
                              height="15rem" :row-style="tableRowStyle4" :header-cell-style="tableHeaderColor4"
                              :cell-style="tableCellStyle4" class="dataTable">
                              <el-table-column prop="machineId" label="设备号">
                              </el-table-column>
                              <el-table-column prop="beamOutTime" label="预测时间">
                              </el-table-column>
                      ...
                      <el-tab-pane label="当前了机" name="three">
                        <el-row>
                          <el-col :span="12">
                            <!--<div style="width: 100%;margin-left:1.2rem;font-size: 1rem;font-weight:bolder;color: lightblue" >&nbsp;&nbsp;&nbsp;&nbsp;{{$t('lang.shebeihao')}}<span style="margin-left: 3.2rem">{{$t('lang.chixushijian')}}</span>&nbsp;&nbsp;</div>-->
                            <el-table :data="lioajiIngData.slice(0,this.lioajiIngData.length/2)" height="15rem"
                              :row-style="tableRowStyle4" :header-cell-style="tableHeaderColor4"
                              :cell-style="tableCellStyle4" class="dataTable" style="width:100%">
                              <el-table-column prop="machineId" label="设备号">
                              </el-table-column>
                              <el-table-column prop="liaojiTimeNum" label="持续时间">
                              </el-table-column>
                            </el-table>
                          </el-col>
                          <el-col :span="12">
                            <!--<div style="width: 100%;margin-left:1.2rem;font-size: 1rem;font-weight:bolder;color: lightblue" >&nbsp;&nbsp;&nbsp;&nbsp;{{$t('lang.shebeihao')}}<span style="margin-left: 3.2rem">{{$t('lang.chixushijian')}}</span>&nbsp;&nbsp;</div>-->
                            <el-table :data="lioajiIngData.slice(this.lioajiIngData.length/2,this.lioajiIngData.length)"
                              height="15rem" :row-style="tableRowStyle4" :header-cell-style="tableHeaderColor4"
                              :cell-style="tableCellStyle4" class="dataTable">
                              <el-table-column prop="machineId" label="设备号">
                              </el-table-column>
                      ...
                      <el-tab-pane label="预警推送" name="second">
                        <el-table :data="tableData" height="17rem" :row-style="tableRowStyle4"
                          :header-cell-style="tableHeaderColor4" :cell-style="tableCellStyleyujing" class="dataTable">
                          <el-table-column prop="currentDate" label="时间">
                          </el-table-column>
          ...
          <div class="data_con">
            ...
            <div class="cons">
              ...
              <div class="cons_con_con" style="color:#44D7B6" v-for="(item,index) in xlyxList" :key="index"><span
                  ...
                  {{item.shiftEfficiencyF}}%</span></div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        cl_choseItem: "1",
        // show_zjboard: "display:block",
        // show_zbboard: "display:block",
        // show_jsboard: "display:block",
        // show_czboard: "display:block",
        show_zjboard: "display:none",
        show_zbboard: "display:none",
        show_jsboard: "display:none",
        show_czboard: "display:none",
        week: "",
        zj_tablehead: [{
            item: "机台"
          },
    ...
    methods: {
      ...
      getWeftCmpx: function () {
        axios({
            ...
            url: this.xjurl + '/weight/getWeftCmpx?workshopId=' + this.workshopId,
            method: 'get',
            headers: {
      ...
      getProblemsFocusData: function () {
        axios({
            // url: 'http://localhost:7070/sign2/getYieldAnalysis',
            url: this.xjurl + '/s/getEfficiency',
            method: 'post',
            headers: {
              'Content-Type': 'application/json',
              'companyId': this.companyId
      ...
      to(name) {
        if (name == "zj") {
          ...
          //  this.$router.push({path:'/zj/'+this.companyId+'/'+this.workshopId+'/'+this.optionjs})
        } else if (name == "js") {
          this.$router.push({ //跳转并传参数
            path: '/js',
            name: 'js',
          ...
          //  this.$router.push({path:'/js/'+this.companyId+'/'+this.workshopId+'/'+this.optionjs})
        } else if (name == "yb") {
          this.$router.push({ //跳转并传参数
            path: '/yb',
            name: 'yb',
          ...
          //  this.$router.push({path:'/yb/'+this.companyId+'/'+this.workshopId+'/'+this.optionjs})
        }
      },
      chose(name, choseItem) {
        if (name == "zj") {
          ...
          if (choseItem == "效率优秀") {
            let that = this
            axios({
                url: 'http://47.99.156.243:7070/s/getEfficiency', // 效率优秀
                method: 'post',
                headers: {
                  'Content-Type': 'application/json',
            ...
            let that = this
            axios({
                url: 'http://47.99.156.243:7070/s/getEfficiency', // 效率落后（低效机台）
                method: 'post',
                headers: {
                  'Content-Type': 'application/json',
                  'companyId': that.companyId
          ...
          axios({
              url: 'http://47.99.156.243:7070/app/getTypeInfo', //品种开台数
              method: 'post',
              headers: {
                'Content-Type': 'application/json',
                'companyId': that.companyId
          ...
          let endDate = that.getNowday()
          axios({
              url: 'http://47.99.156.243:7070/app/getTypeInfo', //品种产量
              method: 'post',
              headers: {
                'Content-Type': 'application/json',
                'companyId': that.companyId
      ...
      jsEchart() { //浆纱图表
        ...
        let option = {
          ...
          series: [{
            data: [120, 600, 150, 180, 170, 110, 130],
            type: 'bar',
            itemStyle: {
              normal: {
                //这里是重点
      ...
      ybEchart() { //验布图表
        ...
        let option = {
          ...
          series: [{
            data: [120, 600, 150, 80, 70, 110, 130],
            type: 'bar',
            itemStyle: {
              normal: {
                //这里是重点
      ...
      getData(workshopId) {
        ...
        axios({
            url: 'http://47.99.156.243:7070/ab/getLiaoJiWithWorkshop', // 了机时间
            method: 'post',
            headers: {
              'Content-Type': 'application/json',
              'companyId': that.companyId
        ...
        axios({
            url: 'http://47.99.156.243:7070/ab/getLiaoJiIng  ', // 待机时长
            method: 'post',
            headers: {
              'Content-Type': 'application/json',
              'companyId': that.companyId
        ...
        axios({
            url: 'http://47.99.156.243:7070/ab/getWorkshopABAndYield?workshops=' + workshopId, // 当班效率，折标产量，平均车速
            method: 'get',
            headers: {
              'Content-Type': 'application/json',
              'companyId': that.companyId
          ...
          .then(response => {
            ...
            that.zbcl = response.data.data.selects[0].yieldXs
        ...
        axios({
            url: 'http://47.99.156.243:7070/weight/getWeftCAndWarpC?workshopId=' + workshopId +
              '&orderType=desc&limitSize=6&orderColumn=weft_c&date=' +
              time, // 当班效率，折标产量，平均车速
            method: 'get',
            headers: {
              'Content-Type': 'application/json',
          ...
          .then(response => {
            ...
            for (let i = 0; i < response.data.data.length; i++) {
              let json = {
                machineid: response.data.data[i].machineid,
                weftC: response.data.data[i].weftC
              }
              let json2 = { //断经
                machineid: response.data.data[i].machineid,
                warpC: response.data.data[i].warpC
              }
              list.push(json)
              list2.push(json2)
            }
        ...
        axios({
            url: 'http://47.99.156.243:7070/app/getMachineRepairBoard', //设备维修
            method: 'post',
            headers: {
              'Content-Type': 'application/json',
              'companyId': that.companyId
          ...
          .then(response => {
            ...
            for (let i = 0; i < response.data.data.data.length; i++) { //黑色看板的数据处理
              if (response.data.data.data[i].status == "已完成") {
                response.data.data.data[i].color = "color:rgb(65, 252, 0);text-algin:center;"
              } else {
                response.data.data.data[i].color = "color:red;text-algin:center;"
              }
        ...
        axios({
            url: 'http://47.99.156.243:8226/warp/getXHBoardWarp?workshopId=' + workshopId, //整经车间管理看板
            method: 'get',
            headers: {
              'Content-Type': 'application/json',
              'companyId': that.companyId
          ...
          .then(response => {
            ...
            for (let i = 0; i < response.data.data2.length; i++) {
              ...
              if (response.data.data2[i].barCode) {
                barcode.push(response.data.data2[i].barCode)
              }
              response.data.data2[i].dtl = parseInt(response.data.data2[i].maximumBrokenEnds / ((response.data.data2[
                i].workQty / 10000) * (response.data.data2[i].totalWarpNumber / 100)))
              zjcjSum = zjcjSum + response.data.data2[i].currentLength
              zjcjSpeed = zjcjSpeed + response.data.data2[i].currentSpeed

              if (response.data.data2[i].finish == null) {
                response.data.data2[i].finish = 0
              }
              if (response.data.data2[i].dtl !== response.data.data2[i].dtl) { //判断是否NaN
                response.data.data2[i].dtl = 0
              }
              list.push(response.data.data2[i])
            }
            ////console.log(list)


            list = that.sortByKey(list, "finish")
            ////console.log(list)
            let b = []
            for (let l = list.length - 1; l >= 0; l--) {
              ////console.log(list[l])

              list[0].color = "color:red"

              list[l].finish = list[l].finish + "%"
              b.push(list[l])
            }
            ////console.log(barcode)
            ...
            that.BarCodeList = barcode
            that.zjcjSum = zjcjSum
            that.zjcjSpeed = parseInt(zjcjSpeed / response.data.data2.length)
            // for (let i = 0; i < response.data.data.data.length; i++) { //黑色看板的数据处理
            //   if (response.data.data.data[i].status == "已完成") {
            //     response.data.data.data[i].color = "color:rgb(65, 252, 0)"
            //   } else {
            //     response.data.data.data[i].color = "color:red"
            //   }
            //   list.push(response.data.data.data[i])
            // }
            // that.sbwxList = list
        ...
        axios({
            url: 'http://47.99.156.243:8226/machine/getXHBoardSlasher?workshopId=' + workshopId, //浆纱车间管理看板
            method: 'get',
            headers: {
              'Content-Type': 'application/json',
              'companyId': that.companyId
          ...
          .then(response => {
            ...
            for (let i = 0; i < response.data.data2.length; i++) {
              ...
              jscjSum = jscjSum + response.data.data2[i].actualYarnLength
              jscjSpeed = jscjSpeed + response.data.data2[i].speed

              if (response.data.data2[i].finish == null) {
                response.data.data2[i].finish = 0
              }
              response.data.data2[i].speed = response.data.data2[i].speed + "m/min"

              list.push(response.data.data2[i])
            }

            that.jscjList = list
            that.jscjSum = jscjSum
            that.jscjSpeed = parseInt(jscjSpeed / response.data.data2.length)
            ////console.log(that.jscjSpeed)
            ////console.log(that.jscjSum)
            // for (let i = 0; i < response.data.data.data.length; i++) { //黑色看板的数据处理
            //   if (response.data.data.data[i].status == "已完成") {
            //     response.data.data.data[i].color = "color:rgb(65, 252, 0)"
        ...
        axios({
            url: 'http://47.99.156.243:7070/lm_shift_his/selectStaffAndYield', //个人排名
            method: 'post',
            headers: {
              'Content-Type': 'application/json',
              'companyId': that.companyId
            ...
            data: {
              workshops: String(that.workshopId)
            }
      ...
      getTypeInfo() { //品种开台数产量统计图数据
        ...
        // // 绘制图表
        // myChart1.clear();
        let myChart2 = this.$echarts.init(document.getElementById('yj_echart'));
        // 绘制图表
        myChart2.clear();
        that.NameList = []
        that.pzktsList = []
      ...
      getYieldAnalysisNew() {
        ...
        that.zzclList = []
        axios({
            url: 'http://47.99.156.243:7070/sign2/getYieldAnalysisNew', //制造产量、效率
            method: 'post',
            headers: {
              'Content-Type': 'application/json',
              'companyId': that.companyId
      ...
      getDate2() {
        let that = this
        // axios({
        //     url: 'http://47.99.156.243:7070/s/getEfficiency', // 效率优秀（低效机台）
        //     method: 'post',
        //     headers: {
        //       'Content-Type': 'application/json',
        //       'companyId': that.companyId
        ...
        let sskjl; //实时开机率
        axios({
            url: 'http://47.99.156.243:7070/app/getStartRates',
            method: 'post',
            headers: {
              'Content-Type': 'application/json',
          ...
          .then(response => {
            ...
            sskjl = response.data.data.data[0].openRate
        ...
        axios({
          ...
          .then(response => {
            //console.log(response)
            for (let i = 0; i < response.data.data.length; i++) {
              response.data.data[i].ShiftDate = (response.data.data[i].ShiftDate).substr(5, 5)
      ...
      mouseover_zj() {
        this.show_zjboard = "display:block;"
        ////console.log(this.show_zjboard)
      },
      mouseleave_zj() {
        this.show_zjboard = "display:none;"
        ////console.log(this.show_zjboard)
      },
      mouseover_js() {
        this.show_jsboard = "display:block;"

      },

      mouseleave_js() {
        this.show_jsboard = "display:none;"

      },
      mouseover_cz() {
        this.show_czboard = "display:block;"

      },
      mouseleave_cz() {
        this.show_czboard = "display:none;"

      },
      mouseover_zb() {
        // this.show_zbboard = "display:none;"
        this.show_zbboard = "display:block;"
      },
      mouseleave_zb() {
        this.show_zbboard = "display:none;"
      ...
      getStartRatesYMD(workshop) {
        ...
        ////console.log(that.companyId);
        axios({
            url: 'http://47.99.156.243:7070/weight/getEffDay?workshopId=' + workshop,
            method: 'get',
            headers: {
              'Content-Type': 'application/json',
              companyId: that.companyId
      ...
      getZhengjing(workshop) { //获取整经数据
        ...
        axios({
            url: 'http://47.99.156.243:7070/warping/getZhengJing?workshopId=' + workshop,
            method: 'get',
            headers: {
              'Content-Type': 'application/json',
              companyId: that.companyId
          ...
          .then(response => {
            ...
            //       response.data.data[i].zwcd = 0
            //     } else {
            //       response.data.data[i].zwcd = (response.data.data[i].current_length / response.data.data[i]
            //         .set_length) * 100
            //       response.data.data[i].zwcd = (response.data.data[i].zwcd.toFixed(1)) * 1
            //     }
            ...
            //       response.data.data[i].zwcd = 0
            //     } else {
            //       response.data.data[i].zwcd = (response.data.data[i].actual_length / response.data.data[i]
            //         .set_length) * 100
            //       response.data.data[i].zwcd = (response.data.data[i].zwcd.toFixed(1)) * 1
            //     }
        ...
        // axios({
        //     url: 'http://47.99.156.243:7070/wanzhou/getZhengjing',
        //     method: 'post',
        //     headers: {
        //       'Content-Type': 'application/json',
      ...
      getJiangsha(workshop) { //获取浆纱数据
        ...
        axios({
            url: 'http://47.99.156.243:7070/warping/getJiangSha?workshopId=' + workshop,
            method: 'get',
            headers: {
              'Content-Type': 'application/json',
              companyId: that.companyId
        ...
        // axios({
        //     url: 'http://47.99.156.243:7070/wanzhou/getJiangsha',
        //     method: 'post',
        //     headers: {
        //       'Content-Type': 'application/json',
        //     },
        ...
        //     ////console.log(response);
        //     for (let i = 0; i < response.data.data.length; i++) {
        //       response.data.data[i].zwcd = (((response.data.data[i].actual_yarn_length / response.data.data[i]
        //         .set_yarn_length) * 100).toFixed(1)) * 1
      ...
      getIframe1: function () {
        ...
        this.src2 = ' http://47.99.156.243:8089/mulanTP2.3/index.php/home/index?CompanyId=' + this.companyId +
      ...
      getWorkShopList: function () {
        axios({
            url: 'http://47.99.156.243:8211/workShop/getWorkShopList',
            method: 'post',
            headers: {
              'Content-Type': 'application/json',
              'companyId': this.companyId
          ...
          .then(response => {
            ...
            this.workshopName = this.workshopList[0].label
          })
          .then(() => {
            this.getIframe1();
      ...
      // 预警数据
      getWarningPushData: function () {
        axios({
            // url: 'http://localhost:7070/sign2/getYieldAnalysis',
            url: this.url + '/s/getWarning',
            method: 'post',
            headers: {
              'Content-Type': 'application/json',
              'companyId': this.companyId
          ...
          .then(response => {
            // ==========预警推送数据表格显示============
            let temptable = [];
            if (response.data.data.map == null)
              temptable = []; //预警数据
            else {
              temptable = response.data.data.map;
            }
            if (this.tableData.length !== 0 && temptable.length > this.tableData.length) {
      ...
      getWarningPushDataTiming: function () {
        const timer = setInterval(() => {
          ...
          //  //console.log(this.getRandomInt(1000,5000))
      ...
      //============选择车间================
      choseFactory: function (workshopId, workshopName) {
      ...
      getzjSum() {
        ...
        url = "http://47.99.156.243:7070/warping/getZhengJing?workshops=" + this.workshopId
      ...
      getzzSum() {
        ...
        url = "http://47.99.156.243:7070/ab/getMultiWorkshopABAndYield?workshops=" + this.workshopId
        ...
        axios({
          ...
          .then(response => {
            ...
            that.sumyb = that.numbertoString(parseInt(parseInt(response.data.data.totalYieldXs) * 2.5) + that
              .getRandomInt(1, 20))
          })
      ...
      // 了机数据
      getLiaojiData: function () {
        axios({
            url: this.xjurl + '/ab/getLiaoJiWithWorkshop',
            method: 'post',
            headers: {
              'Content-Type': 'application/json',
              'companyId': this.companyId
          ...
          .then(response => {
            // ==========了机数据表格显示============
            this.lioajiData = [];
            this.lioajiData = response.data.data;
            //console.log(this.lioajiData)
            //console.log(response)

          })
      },
      // 当前了机
      getLiaojiIngData: function () {
        axios({
            url: this.xjurl + '/ab/getLiaoJiIng',
            method: 'post',
            headers: {
              'Content-Type': 'application/json',
              'companyId': this.companyId
          ...
          .then(response => {
            // ==========了机数据表格显示============
            this.lioajiIngData = [];
            this.lioajiIngData = response.data.data;
        ...
        this.timer = setInterval(() => {
          axios({
            ...
            .then(response => {
              ...
              let now = date.getHours() + ":" + date.getMinutes() + " " + s
              option.xAxis.data.push(now)
              for (let i = 0; i < response.data.data.length; i++) {
                // option.legend.data.push(response.data.data[i].machine_id)
                // let obj={
                //   name:response.data.data[i].machine_id,
                //   type:'line',
                //   data:[]
                // }
                for (let j = 0; j < option.series.length; j++) {
                  if (option.series[j].name == response.data.data[i].machine_id) {
                    option.series[j].data.push(parseFloat(response.data.data[i].speed))
                  }

                }

              }
              if (option.xAxis.data.length >= 7) {
    ...
    mounted() {
      ...
      console.log(this.$route.params.sumyb)
      if (this.$route.params.sumyb) {
        this.sumyb = this.$route.params.sumyb
      }
      //  var timestamp = (new Date()).getTime();
      //   var o=new Date(new Date().toLocaleDateString()).getTime()


      //   this.sumyb=this.numbertoString()
