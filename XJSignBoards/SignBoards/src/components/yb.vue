        ...
        <div class="monitor_left_top">
          <div class="img">
            <div class="img_con"><a @click="back()"
                style="   font-size: 1.2rem;color: #5D7091;text-decoration:none">{{workshopname}}智能织造</a>
              <div class="jiantou"></div><span style="margin-right:1rem">{{workshopname}}</span>
              <div class="jiantou"></div><span>验布机</span>
            </div>
          </div>
