<template>
  <div>
    ...
    <div style="text-align: center;font-size: 12px; display: none" v-for="(item,index) in printData" :class="'printCloths' + index">
      <table border="1" border-color="gray" width="260" cellspacing="0" cellpadding="1" style="font-size: 12px; margin-bottom: 1px; text-align: center; line-height: 14px;"  :key="'printData'+index">
  ...
  export default {
    data () {
      return {
        ...
        orderData:{},
        todayDate:"",
        printMode:1//0为新增布票，不检验printCode,1为新增织布单
      }
    },
    methods:{
      ...
      print(printerName) {
        ...
        for(let i = 0; i < this.printData.length; i++){
          ...
          LODOP.ADD_PRINT_HTM(80, 20, 600, 600, XHPlanTable);
          LODOP.NewPage();
        }
