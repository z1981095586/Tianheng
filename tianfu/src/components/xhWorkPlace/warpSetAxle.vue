<template>
    <div style="width: 1160px;height: 700px;margin-left: 5px">
      ...
      <div style="display: inline-block;height: 50px;line-height: 50px;margin-bottom: 5px" v-if="isJs">
        <p style="display: inline-block;font-size: 25px">输入这是第几缸:</p>
        <el-input ref="cylindersNumber" style="width: 250px;display: inline-block;font-size: 25px" @focus="focusInput ='cylindersNumber'" v-model="cylindersNumber"></el-input>
      </div>
      <div style="display: inline-block;height: 50px;line-height: 50px;margin-bottom: 5px" v-if="isJs">
        <p style="display: inline-block;font-size: 25px">第几个轴:</p>
        <el-input ref="axisNumber" style="width: 250px;display: inline-block;font-size: 25px" @focus="focusInput ='axisNumber'" v-model="axisNumber"></el-input>
      </div>
      <table width="1100px"  cellspacing='0' cellpadding='0' height="300px">
        <tr v-for="indexTr in 3" >
          ...
          <td v-if="indexTr===1">
            <el-button type="primary" style="width:180px;height:180px;font-size: 65px;margin-bottom: 5px;font-weight: bolder" @click="submitData('finish')">提交</el-button>
          </td>
          <td v-if="indexTr===2">
            <el-button type="danger" style="width:180px;height:180px;font-size: 65px;margin-bottom: 5px;font-weight: bolder" @click="returnMain(1,null,null)" >取消</el-button>
          </td>
          <td v-if="indexTr===3">
