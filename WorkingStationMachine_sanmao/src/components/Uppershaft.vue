    ...
    <div class="operationPane_con" style="display:flex;justify-content: center;align-items: flex-start;"
      ...
      <div class="operationPane_con_machineList">
        <div class="shift">
          ...
          <!-- <el-checkbox-group :max="1" @change="checkedName"  :disabled="!isStartChange" v-model="checkName" style="width:100%;height:100%;">
...
<style>
  ...
  .operationPane_con_machineList_btn_right /deep/ .el-pagination.is-background .el-pager li:not(.disabled).active {
    ...
    .operationPane_con_machineList_btn_right /deep/ .el-pagination.is-background.el-pagination--small .btn-next, .el-pagination.is-background.el-pagination--small .btn-prev, .el-pagination.is-background.el-pagination--small .el-pager li{
font-size: 2rem;
    line-height: 2rem;
    height: 4.5rem;
  }
