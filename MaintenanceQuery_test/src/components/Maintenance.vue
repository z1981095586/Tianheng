        ...
        <div v-for="item in datalist">
          ...
          <div class="contain" style="margin-top:10px;" v-else="item.confirm==2">
            <div class="card2">
              ...
              <div class="contain">
                <div class="upload">
                  <el-upload action="http://47.110.242.174 :8206/api/file/fileUpload/maintain" :limit="limit"
...
//         }
        ...
        let that = this;
        axios.get("http://47.110.242.174:8763/com-machine-info/selectAMachineRelation", {
          params: {
 ...
 that.mac_type_id = res.data.data[0].machineType
      ...
      submit() { //提交
        ...
        //数据处理完成，开始更新
        let that = this
        axios.post("http://47.110.242.174:8206/api/maintain/submitMaintain", {
      ...
      getMaintainType() { //获取保养类型
        console.log("das")
        let url = "http://47.110.242.174:8206/api/maintain/getMaintainType"
        let that = this
        axios.post(url, {
          selectInfo: {
            company_id: that.company_id
      ...
      handleRemove(file, fileList, id) { //移除图片
        let url = "http://47.110.242.174:81"
      ...
      getMaintain() { //获取保养信息
        let url = "http://47.110.242.174:8206/api/maintain/getMaintain"
        let that = this
        axios.post(url, {
