<template>
  <div class="content">
    <header style="height: 2rem">
      <div class="title">鑫浪—织造车间电视看板</div>
          ...
          <div class="board_con_right_top">
            <div class="board_con_right_top_con1">
              <div class="board_con_right_top_con1_con"><span
                  style="font-size:2rem;width:5rem;margin-left:5%;margin-right:34%;">当班效率</span><span
                  style="font-size:1.8rem">{{dbxl}}%</span></div>
              <div class="board_con_right_top_con1_con"><span
                  style="font-size:2rem;width:5rem;margin-left:5%;margin-right:34%;">当班产量</span><span
                  style="font-size:1.8rem">{{zbcl}}千米</span></div>
            </div>
            <div class="board_con_right_top_con2">
              ...
              <div class="board_con_right_top_con2_right">
                <div class="board_con_right_top_con2_right_con" v-for="(item,index) in djxlList" :key="index"><span
                    style="font-size:1.5rem;width:50%;text-align:left;margin-left:10%">#{{item.machineid}}</span><span
                    style="font-size:1.5rem;color:rgb(213,119,80);width:40%;text-align:left">{{item.shiftEfficiencyF}}%</span></div>
            ...
            <div class="board_con_left_bottom_con" id="s1">
              <div class="board_con_left_bottom_con_one" v-for="(item,index) in jtList" :key="index"><span
                  style="color:rgb(213,119,80);font-size:1.5rem">#{{item.MachineID}}</span><span style="font-size:1.5rem">{{item.warp_t}}s</span>
              </div>
            ...
            <div class="board_con_left_bottom_con" id="s2">
              <div class="board_con_left_bottom_con_one" v-for="(item,index) in wtList" :key="index"><span
                  style="color:rgb(213,119,80);font-size:1.5rem">#{{item.MachineID}}</span><span style="font-size:1.5rem">{{item.weft_t}}s</span>
              </div>
            ...
            <div class="board_con_right_top_con">      <div class="board_con_right_top_con2_left"><span style="font-size:2rem;width:4rem">断头排名</span></div>
                ...
                <div class="board_con_right_top_con2_right_con" v-for="(item,index) in dtpmList" :key="index"><span
                    style="font-size:1.5rem;width:50%;text-align:left;margin-left:10%">#{{item.MachineID}}</span><span
                    style="font-size:1.5rem;color:rgb(213,119,80);width:40%;text-align:left">{{item.weft_c}}次</span></div>
 ...
 <div class="board_con_right_bottom_right_con">
       ...
       <div class="board_con_right_bottom_right_con">
          <span>A班产量</span><span>{{zbcl}}千米</span>
      </div>

       <div class="board_con_right_bottom_right_con">
          <span>B班产量</span><span>{{bbcl}}千米</span>
      </div>
  </div>
          </div>
        </div>
...
getdata(){
  ...
  axios({
    ...
    axios({
       ...
       that.zbcl=(response.data.data.selects[0].yieldXs/1000).toFixed(1)
          that.bbcl=(response.data.data.selects[0].yesterdayYieldXs/1000).toFixed(1)
