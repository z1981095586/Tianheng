              ...
              <div class="warp">
                ...
                <div class="tableWarp">
                  ...
                  <el-row style="margin-top: 0.3rem">
                    ...
                    <el-col :span="8"><div class="headTitle" style="font-size: 0.8rem;padding: 0">最新完成浆纱信息</div></el-col>
                    <el-col :span="8"><div class="line"></div></el-col>
                  </el-row>
                  <el-row style="margin: 0.2rem 0">
                    ...
                    <el-col :span="6"><div class="tableText" style="font-size: 0.8rem">轴号</div></el-col>
                  </el-row>
                  <el-row style="margin-bottom: 0.3rem">
                    <el-col :span="6"><div class="tableText" style="font-size: 0.8rem" v-show="item.beamName!=null && item.beamName!==''">{{dateFormat(item.endDate)}}</div></el-col>
                    <el-col :span="6"><div class="tableText" style="font-size: 0.8rem" v-show="item.beamName!=null && item.beamName!==''">{{item.empId}}</div></el-col>
                    <el-col :span="6"><div class="tableText" style="font-size: 0.8rem" v-show="item.beamName!=null && item.beamName!==''">{{item.nameC}}</div></el-col>
                    <el-col :span="6"><div class="tableText" style="font-size: 0.8rem" v-show="item.beamName!=null && item.beamName!==''">{{item.beamName}}</div></el-col>
                  </el-row>
                  <el-row style="margin: 0.3rem 0">
                    <el-col :span="6"><div class="tableText" style="font-size: 0.8rem">实际纱长</div></el-col>
                    <el-col :span="6"><div class="tableText" style="font-size: 0.8rem">设定纱长</div></el-col>
                    <el-col :span="6"><div class="tableText" style="font-size: 0.8rem">实际退绕纱长</div></el-col>
                    <el-col :span="6"><div class="tableText" style="font-size: 0.8rem">设定退绕纱长</div></el-col>
                  </el-row>
                  <el-row>
                    <el-col :span="6"><div class="tableText" style="font-size: 0.8rem" v-show="item.beamName!=null && item.beamName!==''">{{item.workQty}} </div></el-col>
                    <el-col :span="6"><div class="tableText" style="font-size: 0.8rem" v-show="item.beamName!=null && item.beamName!==''">{{item.yarnLength}}</div></el-col>
                    <el-col :span="6"><div class="tableText" style="font-size: 0.8rem" v-show="item.beamName!=null && item.beamName!==''">{{item.unwindingLength}}</div></el-col>
                    <el-col :span="6"><div class="tableText" style="font-size: 0.8rem" v-show="item.beamName!=null && item.beamName!==''">{{item.setUnwindingLength}}</div></el-col>
                  </el-row>
                  <!--<el-table
                    :data="warp1"
    ...
    export default {
      ...
      methods:{
        ...
        getBoardData:function () {
          this.$axios({
            url:this.url+'/machine/getXHBoardSlasher?workshopId=3',
            method:'GET',
            headers:{
...
<style scoped>
  .sizingBody{
    background-image: url("../../../static/img/ciyuanjs.png");
