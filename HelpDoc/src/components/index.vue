    ...
    <div class="main">
      ...
      <div class="content">
        ...
        <div>
          ...
          <el-upload style="margin:2rem" class="upload-demo" drag ref="upload" :limit="2" action="http://106.12.219.66:14100/mes/file_upload"
          ...
          <el-button type="warning" @click="download()">下载Word</el-button>
        ...
        let data = {
            ...
            //console.log(res.data.data)
             for(let i=0;i<res.data.data.length;i++){
                  //console.log(res.data.data[i].pid)
             }
