      ...
      <div class="main">
        <div class="main_con">
          <div class="kcgk_con" v-show="kcgk_show">
            <div :class="[item.flag==true?'kcgk_con_one_in':'kcgk_con_one_out']" :style="item.back" v-for="(item,index) in dataList"
          ...
          <div class="kctj_con" v-show="kctj_show">
            <div class="title_info">
              ...
              <div class="Stock_type"><span>库存品种：&nbsp;&nbsp;&nbsp;{{style_num}}</span></div>
            </div>
            ...
            <div class="kc_table">
              <div class="table2">
                <el-table :data="tableData2" height="100%" border
                  ...
                  <el-table-column prop="library_name" label="库位" width="90">
                  </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      inventoryInquiry(library_num, library_name, axis_name, style_name, type) { //轴库查询
        let url = "http://47.99.156.243:8206/api/axis/inventoryInquiry"
        let that = this
      ...
      inventoryStatistics() { //库存统计
        let url = "http://47.99.156.243:8206/api/axis/inventoryStatistics"
        let that = this
      ...
      getAllAxis() { //获取库存概况
        let url = "http://47.99.156.243:8206/api/axis/getAllAxis"
        let that = this
        let selectInfo = {
          company_id: that.companyID
        }
      ...
      getInAndOutRecord() { //获取出入库明细
        let url = "http://47.99.156.243:8206/api/axis/getInAndOutRecord"
        let that = this
      ...
      clear() { //出入库明细清零
        let url = "http://47.99.156.243:8206/api/axis/clearAxisLibraryRecord"
        let that = this
...
//             }
        let currentName=""
let url = "http://47.99.156.243:16099/api/beam/getBeamList"
for(let i=0;i<that.dataList.length;i++){
  that.dataList[i].back=null
}
  ...
  if(that.dataList[i].library_name==currentName){
    that.dataList[i].back="background:red;"
      ...
      checkPassword() {
        ...
        if (this.staff_id) {
          let url = "http://47.99.156.243:8206/api/axis/verifyPassword"
          let that = this
