  ...
  export default {
    ...
    methods: {
      ...
      add() {
        console.log(this.form)
        let that = this
        let url = "http://47.99.156.243:8206/api/staff/addStaff"
      ...
      getRootStaffOrganization() { //获取根组织
        let url = "http://47.99.156.243:8206/api/staff/getRootStaffOrganization"
      ...
      getStaffListByOrganization(id) { //获取指定组织下的所有员工列表(包括子组织)
        let url = "http://47.99.156.243:8206/api/staff/getStaffListByOrganization"
        let that = this
