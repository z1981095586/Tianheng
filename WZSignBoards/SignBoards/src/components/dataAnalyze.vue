      ...
      <h1 class="tip">
        ...
        <el-dialog id="dialog" center width="22%" :modal="false" :visible.sync="dialogFormVisible">
          <el-button
            ...
            @click="choseFactory(item.value)" v-for="item in workshopList" :key="item.value">{{item.label}}</el-button>
        </el-dialog>
    ...
    <el-row :gutter="5">
          ...
          <el-col :span="24">
            <div class="factoryProduction">
              <div style="text-align: left;margin-left: 5%;padding-top: 0.6rem">
                <span class="unChoosetbTitle" :class="{'choose':this.chanliangtuyi===true}"
                  @click="switchZCLAndCLTY('clty')">{{$t('lang.chanliangtuyi')}}</span>
              </div>
              <el-row>
      ...
      <el-col :span="10">
        <div class="centerContent">
          <div>
            <div style="font-weight: bold;font-size: 1.5rem;text-align: center;padding-top: 1rem">今 日 总 产 量</div>
            <div style="font-weight: bold;font-size: 1.4rem;text-align: center;color: rgba(58,214,185,0.9)">
            <countTo :startVal='startVal' :endVal='endVal' :duration='20000'></countTo>米</div>
          </div>
          <div class="mod_efficiency">
                  <div class="mod_efficiency_con">
              <div id="efficiencyChart5" style="width:10rem;height:10rem;"></div>
              <div class="mod_efficiency_con_right">
                    <div class="mod_efficiency_con_right_con">
                  <span>转速/分</span>
                  <div id="BEfficiencyChart5" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                    <div class="mod_efficiency_con_right_con">
                 <span style="left:2.5rem">台/米</span>
                  <div id="AEfficiencyChart5" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                <div class="mod_efficiency_con_right_con">
                  <span>A班效率</span>
                  <div id="AxEfficiencyChart5" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                <div class="mod_efficiency_con_right_con">
                  <span>B班效率</span>
                  <div id="BxEfficiencyChart5" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>

              </div>
            </div>
                  <div class="mod_efficiency_con">
              <div id="efficiencyChart4" style="width:10rem;height:10rem;"></div>
              <div class="mod_efficiency_con_right">
                    <div class="mod_efficiency_con_right_con">
                  <span>转速/分</span>
                  <div id="BEfficiencyChart4" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                    <div class="mod_efficiency_con_right_con">
                  <span style="left:2.5rem">台/米</span>
                  <div id="AEfficiencyChart4" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                <div class="mod_efficiency_con_right_con">
                  <span>A班效率</span>
                  <div id="AxEfficiencyChart4" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                <div class="mod_efficiency_con_right_con">
                  <span>B班效率</span>
                  <div id="BxEfficiencyChart4" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>

              </div>
            </div>
            <div class="mod_efficiency_con">
              <div id="efficiencyChart2" style="width:10rem;height:10rem;"></div>
              <div class="mod_efficiency_con_right">
                    <div class="mod_efficiency_con_right_con">
                  <span>转速/分</span>
                  <div id="BEfficiencyChart2" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                    <div class="mod_efficiency_con_right_con">
                  <span style="left:2.5rem">台/米</span>
                  <div id="AEfficiencyChart2" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                <div class="mod_efficiency_con_right_con">
                  <span>A班效率</span>
                  <div id="AxEfficiencyChart2" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                <div class="mod_efficiency_con_right_con">
                  <span>B班效率</span>
                  <div id="BxEfficiencyChart2" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>

              </div>
            </div>
                <div class="mod_efficiency_con">
              <div id="efficiencyChart3" style="width:10rem;height:10rem;"></div>
              <div class="mod_efficiency_con_right">
                    <div class="mod_efficiency_con_right_con">
                  <span>转速/分</span>
                  <div id="BEfficiencyChart3" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                    <div class="mod_efficiency_con_right_con">
                  <span style="left:2.5rem">台/米</span>
                  <div id="AEfficiencyChart3" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                <div class="mod_efficiency_con_right_con">
                  <span>A班效率</span>
                  <div id="AxEfficiencyChart3" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                <div class="mod_efficiency_con_right_con">
                  <span>B班效率</span>
                  <div id="BxEfficiencyChart3" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>

              </div>
            </div>
                        <div class="mod_efficiency_con">
              <div id="efficiencyChart6" style="width:10rem;height:10rem;"></div>
              <div class="mod_efficiency_con_right">
                    <div class="mod_efficiency_con_right_con">
                  <span>转速/分</span>
                  <div id="BEfficiencyChart6" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                    <div class="mod_efficiency_con_right_con">
                  <span style="left:2.5rem">台/米</span>
                  <div id="AEfficiencyChart6" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                <div class="mod_efficiency_con_right_con">
                  <span>A班效率</span>
                  <div id="AxEfficiencyChart6" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
                <div class="mod_efficiency_con_right_con">
                  <span>B班效率</span>
                  <div id="BxEfficiencyChart6" style="width: 7.5rem;height:7.5rem;position:absolute;top:1.5rem;"></div>
                </div>
              ...
              <div id="failureEquipmentCharts" style="margin-left: 6%;overflow-y:scroll;height: 28rem;width: 34rem;">
                <el-row :key="item.workshopId" v-for="item in unusualStop">
                  ...
                  <el-col :key="machine.stopName" :span="24" v-for="machine in item.stopTypeDTOS">
                    <div v-if="machine.stopName==='经纱停车'" style="width: 32rem;font-size: 1rem;margin-top: 0.5rem"
                      :class="{'jingsha':machine.stopName==='经纱停车'}" class="tbTitle">
                      {{machine.stopName}}({{machine.strings.length}})</div>
                    <div v-else-if="machine.stopName==='纬纱停车'" style="width: 32rem;font-size: 1rem;margin-top: 0.5rem"
                      :class="{'weisha':machine.stopName==='纬纱停车'}" class="tbTitle">
                      {{machine.stopName}}({{machine.strings.length}})</div>
                    <div v-else-if="machine.stopName==='其他'" style="width: 32rem;font-size: 1rem;margin-top: 0.5rem"
                      :class="{'qita':machine.stopName==='其他'}" class="tbTitle">
                      {{machine.stopName}}({{machine.strings.length}})</div>
                    <div style="float: left;margin:0.2rem 0;width: 4rem;text-align: left"
                      v-for="machineId in machine.strings" class="tbText">
                      <span v-if="machine.stopName==='经纱停车'"
                        :class="{'jingsha':machine.stopName==='经纱停车'}">{{machineId}}</span>
                      <span v-else-if="machine.stopName==='纬纱停车'"
                        :class="{'weisha':machine.stopName==='纬纱停车'}">{{machineId}}</span>
                      <span v-else-if="machine.stopName==='其他'"
                        :class="{'qita':machine.stopName==='其他'}">{{machineId}}</span>
                    </div>
                  </el-col>
                  <!-- <el-col :span="24">
  ...
  export default {
    ...
    methods: {
      ...
      showSizingDetail: function (machineId) {
        this.sizingDetail = {};
        this.sizingDetail = this.sizing.filter(x => {
      ...
      getProductionTime: function () {
        ...
        for (let i = 0; i < list.length; i++) {
          ...
          //   list[i]=k
          // }
          if (list[i].indexOf("万舟") != -1) {
            list[i] = list[i].replace("万舟", "")
          }
        }
        for (let i = 0; i < this.totalProductSeries.length; i++) {
          // if(list[i]=="万舟织造二部"){
          //  let k=list[list.length-1];
          //   list[list.length-1]=list[i];
          //   list[i]=k
          // }
          if (this.totalProductSeries[i].name.indexOf("万舟") != -1) {
            this.totalProductSeries[i].name = this.totalProductSeries[i].name.replace("万舟", "")
          }
        }
        //console.log(list)
        //console.log(this.totalProductSeries)
        myChart1.setOption({
          tooltip: {
            trigger: 'axis',
            axisPointer: {
      ...
      getFailureEquipmentData: function () {
        ...
        axios({
          ...
          .then(response => {
            ...
            this.unusualStop =[]
            for(let i=0;i<response.data.data.unusualStop.length;i++){
              if(response.data.data.unusualStop[i].workshopId==this.workshopId){
                this.unusualStop.push(response.data.data.unusualStop[i])
              }
            }
                 console.log(this.unusualStop)
      ...
      getSpeciesDistribution: function () {
        axios({
          ...
          .then(response => {
            ...
            this.styleList = temp.map(x => {
              return {
                value: x.machine.length,
                name: x.styleName
              }
            });
            this.styleList.push({
      ...
      getEfficiency() {
        axios({
            url: this.url + '/ab/getWorkshopABAndYield?workshops="1","2","4","5","6"',
            method: 'get',
            headers: {
              'Content-Type': 'application/json',
              'companyId': this.companyId
          ...
          .then(response => {
            ...
            this.endVal=data.totalYield
            setTimeout(() => {
              this.startVal=data.totalYield
            }, 1000);
            ...
            let totalwanzhou2Efficiency = '';
                   let Awanzhou3Efficiency = '';
            let Bwanzhou3Efficiency = '';
            let totalwanzhou3Efficiency = '';
            ...
            let wanzhou1Efficiency = data.selects.filter(x => {
              return x.workshops === '"4"'
            })[0];
            let wanzhou2Efficiency = data.selects.filter(x => {
              return x.workshops === '"5"'
            })[0];
            let lanmianEfficiency = data.selects.filter(x => {
              return x.workshops === '"2"'
            })[0];
            let jiaermeiEfficiency = data.selects.filter(x => {
              return x.workshops === '"1"'
            })[0];
               let wanzhou3Efficiency = data.selects.filter(x => {
              return x.workshops === '"6"'
            })[0];
       ...
       Awanzhou3Efficiency = wanzhou3Efficiency.list[0]; // A班效率
            Bwanzhou3Efficiency = wanzhou3Efficiency.list[1]; // B班效率
            totalwanzhou3Efficiency = wanzhou3Efficiency.list[2]; // 总效率
            ...
            this.Bwanzhou2Efficiency = Bwanzhou2Efficiency;
               this.Awanzhou3Efficiency = Awanzhou3Efficiency;
            this.Bwanzhou3Efficiency = Bwanzhou3Efficiency;
            ...
            let wanzhou2Rpm = parseInt(wanzhou2Efficiency.rpm);
                let wanzhou3AvgProductMeter = Number(wanzhou3Efficiency.avgProductMeterXs);
            let wanzhou3Rpm = parseInt(wanzhou3Efficiency.rpm);
            ...
            //console.log(totalwanzhou1Efficiency)
            //console.log(wanzhou1AvgProductMeter)
            this.getWorkshopEfficiency(totalwanzhou1Efficiency, '一部', 2);
            this.getWorkshopEfficiency(totalwanzhou2Efficiency,'二部',3);
                this.getWorkshopEfficiency(totalwanzhou3Efficiency,'三部',6);
            ...
            this.getABEfficiency('Ax',2,Awanzhou1Efficiency)
                 this.getABEfficiency('Bx',2,Bwanzhou1Efficiency)

             this.getABEfficiency('A',3,wanzhou2AvgProductMeter);
                this.getABEfficiency('Ax',3,Awanzhou2Efficiency)
                 this.getABEfficiency('Bx',3,Bwanzhou2Efficiency)

             this.getABEfficiency('A',4,lanmianAvgProductMeter);
                        this.getABEfficiency('Ax',4,AlanmianEfficiency)
                 this.getABEfficiency('Bx',4,BlanmianEfficiency)

            this.getABEfficiency('A',5,jemAvgProductMeter);
     this.getABEfficiency('Ax',5,AjiaermeiEfficiency)
                 this.getABEfficiency('Bx',5,BjiaermeiEfficiency)
            this.getABEfficiency('A',6,wanzhou3AvgProductMeter);
                this.getABEfficiency('Ax',6,Awanzhou3Efficiency)
                 this.getABEfficiency('Bx',6,Bwanzhou3Efficiency)
     ...
     this.getABEfficiency('B', 6, wanzhou3Rpm);
          });
...
margin-top: 0.8rem;
  ...
  .mod_efficiency_con_right_con span {
