<template>
  <div class="content">
    <header style="height: 3rem">
      <div class="title">万舟织造二部——万舟集团验布车间看板</div>
      ...
      <div class="board_top">
        ...
        <div class="board_top_middle">
          <div class="board_top_middle_con">
            ...
            <div class="number">{{defectMeter}}米</div>
          ...
          <div class="board_top_right_con">
            <div class="board_top_right_top">
              <div class="board_top_right_top_title">
                <div class="img">
                  <div class="img_line"></div><div class="radius"></div>
                </div>
                <div class="fonts">今日检验小能手</div>
                <div class="img2">  <div class="radius"></div>  <div class="img_line2"></div>
              
                </div>
              </div>
              <div class="board_top_right_top_content">
            ...
            <div class="board_top_right_bottom">
              ...
              <div class="board_top_right_bottom_content">
  ...
  export default {
    ...
    methods: {
     ...
     if(response.data.data.meterCompareList.length>=10){
                 for (let i = response.data.data.meterCompareList.length - 1; i > (response.data.data.meterCompareList.length - 10); i--) {
...
//             ]
              ...
              series: [{
                  ...
                  //       data: [120, 600, 150, 80, 70, 110, 130, 123, 134, 132],
                   barGap :"35%",
                  markPoint: {
                    data: [{
                        type: 'max',
      ...
      getData() {
        ...
        axios({
          ...
          .then(response => {
            that.defectMeter = response.data.data.defectMeter
          })
        axios({
