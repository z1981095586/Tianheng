...
//console.log(nowday)
        ...
        axios({
          ...
          .then(response => {
            ...
            for (let i = 0; i < list.length; i++) {
              list[i].shift_yield = parseFloat(list[i].shift_yield.replace(/,/g, ''))
              list[i].shift_aef = parseFloat(list[i].shift_aef)
            }
    ...
    if(   response.data.data[i].current_time.indexOf("06:45")!=-1){
      ...
      response.data.data[i].current_all_yield=parseInt( response.data.data[i].current_all_yield)
     ...
     //////console.log(arr)
         ...
         let _d = {  
          ...
          find ? (find.current_all_yield+=item.current_all_yield,find.frequency++ ): obj.push(_d)  
          return obj  
        }, [])
        ////console.log(list2)
