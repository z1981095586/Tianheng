          ...
          <el-row :gutter="5">
            <el-col :span="12" :key="item.machineId" v-for="item in warp">
              <div class="warp">
                ...
                <div class="tableWarp">
                  <el-row style=" margin-top: 1rem;width: 94%;padding-left: 6%;margin-bottom: 0.2rem">
                    <el-col :span="8"><div class="line"></div></el-col>
                    <el-col :span="8"><div class="headTitle" style="font-size: 1rem;padding: 0">浆纱设备信息</div></el-col>
                    <el-col :span="8"><div class="line"></div></el-col>
                  </el-row>
                  <el-row style="margin-top: 0.1rem">
                    <el-col :span="8"><div class="headTitle">实际纱长: {{item.actualYarnLength}}</div></el-col>
                    <el-col :span="8"><div class="headTitle">设定纱长: {{item.setYarnLength}}</div></el-col>
                    <el-col :span="8"><div class="headTitle">车速: {{item.speed}} m/min</div></el-col>
                  </el-row>
                  ...
                  <el-row style="margin-top: 1rem">
                    <el-col :span="8"><div class="line"></div></el-col>
                    <el-col :span="8"><div class="headTitle" style="font-size: 1rem;padding: 0">最新产出浆纱信息</div></el-col>
                    <el-col :span="8"><div class="line"></div></el-col>
                  </el-row>
                  ...
                  <el-row>
                    <el-col :span="6"><div class="tableText">{{item.batchCode}}</div></el-col>
                    <el-col :span="6"><div class="tableText">{{item.workshopName}}</div></el-col>
                    <el-col :span="6"><div class="tableText">{{item.planYieldTotal}}</div></el-col>
                    <el-col :span="6">
                  ...
                  <el-row style="margin-bottom: 0.2rem">
                    ...
                    <el-col :span="6"><div class="tableText" style="font-size: 1rem">{{item.beamName}}</div></el-col>
    ...
    export default {
      ...
      methods:{
        ...
        getBoardData:function () {
          axios({
            url:this.url+'/machine/getWZBoardSlasher?workshopId=1&groupId=1',
            method:'get',
            ...
            this.warp=[];
            let result = response.data.data.jsList;
            result = this.sortByKey(result,'machineId');
            this.warp = result;
         /*   this.warp.forEach(x=>{
              x.speed = x.speed+parseInt(Math.random()*5);
              if (x.actualYarnLength<=x.setYarnLength)
                x.actualYarnLength = x.actualYarnLength+parseInt(Math.random()*25);
              else
                x.actualYarnLength = 0;
            })*/
          })
        },
        //数组对象方法排序:
        ...
        changePage:function () {
          const timer = setInterval(() =>{
              this.sizingShow = !this.sizingShow;
          }, 5000);
