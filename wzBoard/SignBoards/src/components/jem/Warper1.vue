    ...
    <div class="warpBody">
      <div class="warper">
        ...
        <transition name="transitionRouter" mode="out-in">
          <div class="content1" v-show="warpShow">
            <el-row :gutter="5">
        ...
        <transition name="transitionRouter" mode="out-in">
          <warper11 class="content2" v-show="!warpShow"></warper11>
        </transition>
...
<script>
    ...
    import Warper11 from './Warper1-1'
    import copyRight from '../copyRight'
    export default {
      name: "Warper1",
      components: {Warper11,copyRight},
      data(){
        return{
      ...
      methods:{
        ...
        getBoardData:function () {
          axios({
            url:this.url+'/warp/getWZBoardWarp?workshopId=1&groupId=1',
            method:'get',
            ...
            this.warp = result;
          /*  this.warp.forEach(x=>{
                x.currentSpeed = x.currentSpeed+parseInt(Math.random()*5);
                if (x.currentLength<=x.setLength)
                  x.currentLength = x.currentLength+parseInt(Math.random()*15);
                else
                  x.currentLength = 0;
            })*/
          })
